...
class BF_Model extends CI_Model
{
	...
	*/
    ...
    public function find_all_index_by_key()
    {
        $result = $this->find_all_empty_array();
    ...
    public function find_all_indexed_key($key)
    {
        $result = $this->find_all_empty_array();
