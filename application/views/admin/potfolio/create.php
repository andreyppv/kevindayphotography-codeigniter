    ...
    <div class="col-lg-12">
        ...
        <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')); ?>
            ...
            <div class="form-group <?php echo form_error('potfolio-name') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="potfolio-name" name="potfolio-name" placeholder="Title" value="<?php echo set_value('potfolio-name'); ?>" required>
            ...
            <div class="form-group <?php echo form_error('potfolio-slug') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="potfolio-slug" name="potfolio-slug" placeholder="Slug" value="<?php echo set_value('potfolio-slug'); ?>" required>
