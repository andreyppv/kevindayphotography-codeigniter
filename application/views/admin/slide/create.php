    ...
    <div class="col-lg-12">
        ...
        <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal', 'id' => 'aform', 'autocomplete' => 'off')); ?>
            <div class="form-group <?php echo form_error('slide-name') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="slide-name" name="slide-name" placeholder="Name" value="<?php echo set_value('slide-name'); ?>" required>
            ...
            <div class="form-group <?php echo isset($slide_image_message) ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <div class="avatar-img-box" style="margin-bottom:5px;">
                        <img src="<?php echo thumbnail('', 250, 250); ?>" id="slide-avatar-img"/>
                    </div>
            ...
            <div class="form-group <?php echo form_error('slide-text') ? 'has-error' : ''; ?>">
                ...
                <div class="col-sm-8">
                    <textarea rows="5" class="form-control" id="slide-text" name="slide-text" placeholder="Text" required><?php echo set_value('slide-text'); ?></textarea>
